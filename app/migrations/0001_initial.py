# Generated by Django 3.0.8 on 2021-01-27 22:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='Award/%Y/%m/%d/', verbose_name='懸賞任務')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_memo', models.CharField(choices=[('家屬購買', '家屬購買'), ('task', '任務所得'), ('other', '其他')], default=' ', max_length=40, verbose_name='交易內容')),
                ('slug', django_extensions.db.fields.RandomCharField(blank=True, editable=False, length=32, unique=True, unique_for_date='transaction_date')),
